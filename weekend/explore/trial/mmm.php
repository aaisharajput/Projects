  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="#">Booked Trip</a>
      </div>
    </li>
     <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="video">
              <video style="border:2px solid red"></video>
            </div> 
            <div class="video_content">
            <h6>Malani tour 2day 1 night</h6>
           </div>
          </div>
            <div class="col-md-5">
                <div class="rating">
            ...
            <div class="col-12"><hr>
                <div class="box">
                    ...
                    <h6>Love This Trip</h6>
                    <small>By Aaisha on Mon, june7,2021</small>
                   </div>
                </div>
                <hr class="hr">
                <div class="box">
