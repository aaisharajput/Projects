          ...
          {/* <% }else{%> */}
            ...
            {/* <%}%> */}
                <div className="form-group form-inline justify-content-center">
                    ...
                    <input type="password" className={`form-control ml-5 ${style.inp}`} name="pwd" placeholder="Enter Password" id="pswd" required/>
                ...
                <div className="form-group form-inline pt-4 justify-content-center">
                  ...
                  <input type="password" className="form-control ml-4 inp" name="conf" placeholder="Enter Confirm password" id="cnf_pswd" required/>
                </div>
                 {/* <input type="email" name="email" value="<%=email%>" hidden /> */}
                  <a href="/">Go Back</a><br/>
                  <button type="submit" className={`${style.btn} btn pl-5 pr-5 mt-4`} id="change">Change</button>     
                
                <p style={{color:'red'}} className="pt-3" id="error_msg"></p>
                {/* <p className="text-success pt-3"><%= change_msg %></p> */}
              </form>
              <div className="row">
                <div className="col-12 col-md-4"></div>
                <div className="col-12 col-md-8">
                  <div className="row">
                    <div className="col-12 col-md-12"><p>*Password should have 12 or more characters!!</p></div>
                    <div className="col-12 col-md-12"><p>*Password should contain atleast one special symbols!!</p></div>
                    <div className="col-12 col-md-12"><p>*Password should contain atleast one number!!</p></div>
                    <div className="col-12 col-md-12"><p>*Password should contain atleast one Uppercase character!!</p></div>
                    <div className="col-12 col-md-12"><p>*Password should contain atleast one Lowercase character!!</p></div>
                  </div>
