...
import {auth,chkAuthenticationIndex,chkAuthenticationLogin,chkAuthenticationSignup,log_in,sign_up,verify_token,verify_email,
    changePswdforgot,forgotPswd} from "../services/IndexService.js";
import {authCheck,redirectHome,renderHome,verifyNow,changePswd,renderLogin,renderChangePswd,renderForgotPswd} from "../Controllers/IndexController.js";
// import {render404} from "../Controllers/MutualController.js";

Router.get("/",redirectHome); 

Router.post("/checkAuth",auth,authCheck)
